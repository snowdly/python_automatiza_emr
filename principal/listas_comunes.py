...
lista_completa = [
 {'Etiqueta': './/Datos_Certificacion/Tipo_Certificacion', 'Regla': 'R_Datos_Certificacion_Tipo_Certificacion', 'Comparacion': 'Se compara con el parámetro Titular_Nombre_Razon_Social del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Tipo_Solicitud', 'Regla': 'R_Datos_Certificacion_Tipo_Solicitud', 'Comparacion': 'Se compara con el parámetro Expediente_Concesional del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Titular_Nombre_Razon_Social', 'Regla': 'R_Datos_Certificacion_Titular_Nombre_Razon_Social', 'Comparacion': 'Se compara con el parámetro Numero_Visado del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Expediente_Concesional', 'Regla': 'R_Datos_Certificacion_Expediente_Concesional', 'Comparacion': 'Se compara con el parámetro Numero_Visado del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Datos_Visado/Numero_Visado', 'Regla': 'R_Datos_Certificacion_Datos_Visado_Numero_Visado', 'Comparacion': 'Se compara con el parámetro Numero_Colegiado del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Datos_Visado/Fecha_Visado', 'Regla': 'R_Datos_Certificacion_Datos_Visado_Fecha_Visado', 'Comparacion': 'Se compara con el parámetro Colegio_Profesional del documento XML'}
,{'Etiqueta': './/Datos_Certificacion/Datos_Visado/Numero_Colegiado', 'Regla': 'R_Datos_Certificacion_Datos_Visado_Numero_Colegiado', 'Comparacion': 'Se compara con el documento PDF Declaración Responsable de Técnico competente'}
,{'Etiqueta': './/Datos_Certificacion/Datos_Visado/Colegio_Profesional', 'Regla': 'R_Datos_Certificacion_Datos_Visado_Colegio_Profesional', 'Comparacion': 'Se compara con el documento PDF Declaración Responsable de Técnico competente'}
...
,{'Etiqueta': './/Datos_Certificacion/Tecnico_Competente/Apellido1', 'Regla': 'R_Datos_Certificacion_Tecnico_Competente_Apellido1', 'Comparacion': 'Se compara con Excel de Códigos INE'}
,{'Etiqueta': './/Datos_Certificacion/Tecnico_Competente/Apellido2', 'Regla': 'R_Datos_Certificacion_Tecnico_Competente_Apellido2', 'Comparacion': 'Se compara con Excel de Códigos INE'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Codigo_Emplazamiento', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Codigo_Emplazamiento', 'Comparacion': 'Se compara con el Término Municipal del documento Excel de Códigos INE'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Emplazamiento_Compartido', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Emplazamiento_Compartido', 'Comparacion': 'Se compara con el Cod_INE_Provincia del documento Excel de Códigos INE'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Cod_INE_Termino_Municipal', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Cod_INE_Termino_Municipal', 'Comparacion': 'Se compara con información obtenida de la página web de Infoantenas'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Cod_INE_Provincia', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Cod_INE_Provincia', 'Comparacion': 'Se compara con información obtenida de la página web de Infoantenas'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Latitud', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Latitud', 'Comparacion': 'Se compara con el parámetro Datum del documento XML'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Longitud', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Longitud', 'Comparacion': 'Se compara con el dato recogido de la página web de sede catastro'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Datum', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Datum', 'Comparacion': 'Se compara con el valor de la página web de iberpix'}
...
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Cota_Terreno_Sobre_Nivel_Mar', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Cota_Terreno_Sobre_Nivel_Mar', 'Comparacion': 'Se compara con el dato recogido de la página web de sede catastro'}
...
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Calle/Nombre_Via', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Calle_Nombre_Via', 'Comparacion': 'Dato no obligatorio, se utiliza para especificar aún con mas detalle la ubicación de la BTS'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Calle/Numero_Portal', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Calle_Numero_Portal', 'Comparacion': 'Se compara con el titulo del XML'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Emplazamiento/Calle/Situacion', 'Regla': 'R_Estacion_Certificada_Datos_Emplazamiento_Calle_Situacion', 'Comparacion': 'Se comprueba si es una tecnologia valida contra el fichero de referencia pdf'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Codigo_Estacion', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Codigo_Estacion', 'Comparacion': 'Se comprueba el dato contra la web "Sistema de Informacion Urbana"'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Tipo_Sistema', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Tipo_Sistema', 'Comparacion': 'Se coprueba dentro del XML, SI o NO'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Tipo_Estacion', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Tipo_Estacion', 'Comparacion': 'Se comparara con el fichero CAB y debe haber tantos sectores como número indicado'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Entorno_Sensible', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Entorno_Sensible', 'Comparacion': 'Se comparara con el fichero CAB y debe haber tantos sectores como número indicado'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Num_Sectores_Interiores', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Num_Sectores_Interiores', 'Comparacion': 'Se coprueba dentro del XML, PIRE'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Num_Sectores_Exteriores', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Num_Sectores_Exteriores', 'Comparacion': 'Comprobacion dentro del XML, debe de estar llenado y se revisa que sea numero'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Tipo_Potencia_Radiada', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Tipo_Potencia_Radiada', 'Comparacion': 'Comprobacion dentro del XML, debe estar llenado y valor en W'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Potencia_Maxima_Total', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Potencia_Maxima_Total', 'Comparacion': 'Se coprueba con el diseño  CAP/FSC'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Unidad_Potencia_Maxima_Total', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Unidad_Potencia_Maxima_Total', 'Comparacion': 'Se coprueba con el diseño  CAP/FSC'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Localizacion_Antena', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Localizacion_Antena', 'Comparacion': 'Se comprueba con el DATASHEET de la antena'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Tipo_Antena', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Tipo_Antena', 'Comparacion': 'Se compara con dato del CAB'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Polarizacion', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Polarizacion', 'Comparacion': 'Se compara con dato del CAB'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Altura_Antena_Sobre_Terreno', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Altura_Antena_Sobre_Terreno', 'Comparacion': 'Se coprueba dentro del XML, ISO'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Inclinacion_Haz_Sobre_Horizontal', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Inclinacion_Haz_Sobre_Horizontal', 'Comparacion': 'Se comprueba con el DATASHEET de la antena'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Antena_Directiva/Tipo_Ganancia', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Antena_Directiva_Tipo_Ganancia', 'Comparacion': 'Se comprueba con el DATASHEET de la antena'}
...
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Antena_Directiva/Apertura_Horizontal_Haz', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Antena_Directiva_Apertura_Horizontal_Haz', 'Comparacion': 'Se comprueba con el diseño CAP/FSC'}
...
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Antena_Directiva/Acimut_Maxima_Radiacion', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Antena_Directiva_Acimut_Maxima_Radiacion', 'Comparacion': 'Se coprueba dentro del XML,se comprueba si es una forma de volumen correcta'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Antena_Directiva/Nivel_Lobulos_Secundarios', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Antena_Directiva_Nivel_Lobulos_Secundarios', 'Comparacion': 'DEBE COINCIDIR CON LM1 DE LA TABLA DE VOLUMENES COMPUESTOS DEL PDF del certificado radioelectrico'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Volumen_Referencia/Forma_Volumen', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Volumen_Referencia_Forma_Volumen', 'Comparacion': 'DEBE COINCIDIR CON EL COEFICIENTE DEL PDF'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Volumen_Referencia/Distancia_Referencia', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Volumen_Referencia_Distancia_Referencia', 'Comparacion': 'Se comprueba dentro del XML, numero entero no repetido y consecutivo'}
,{'Etiqueta': './/Estacion_Certificada/Datos_Estacion/Sectores/Sector/Volumen_Referencia/Coeficiente_Reflexion', 'Regla': 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector_Volumen_Referencia_Coeficiente_Reflexion', 'Comparacion': 'Se comprueba dentro del XML,debe estar llenado y entre 0 y 100 metros'}
,{'Etiqueta': './/Informe_Medidas/Puntos_Medida/Punto_Medida/IdPunto', 'Regla': 'R_Informe_Medidas_Puntos_Medida_Punto_Medida_IdPunto', 'Comparacion': 'Se comprueba dentro del XML, debe estar llenado y entre 0 y 359 grados'}
,{'Etiqueta': './/Informe_Medidas/Puntos_Medida/Punto_Medida/Distancia', 'Regla': 'R_Informe_Medidas_Puntos_Medida_Punto_Medida_Distancia', 'Comparacion': 'Debe coincidir con datos del PDF del certificado'}
,{'Etiqueta': './/Informe_Medidas/Puntos_Medida/Punto_Medida/Acimut', 'Regla': 'R_Informe_Medidas_Puntos_Medida_Punto_Medida_Acimut', 'Comparacion': 'Debe coincidir con datos del PDF del certificado'}
...
,{'Etiqueta': './/Informe_Medidas/Puntos_Medida/Punto_Medida/Punto_Sensible/Cod_INE_Termino_Municipal', 'Regla': 'R_Informe_Medidas_Puntos_Medida_Punto_Medida_Punto_Sensible_Cod_INE_Termino_Municipal', 'Comparacion': 'Se comprueba dentro del XML,debe ser el DNI concatenado con el nombre completo del técnico.'}
,{'Etiqueta': './/Informe_Medidas/Puntos_Medida/Punto_Medida/Punto_Sensible/Cod_INE_Provincia', 'Regla': 'R_Informe_Medidas_Puntos_Medida_Punto_Medida_Punto_Sensible_Cod_INE_Provincia', 'Comparacion': 'Se comprueba dentro del xml, la fecha de medición caduca cada tres meses.'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Datos_Medicion/Tecnico_Responsable', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Datos_Medicion_Tecnico_Responsable', 'Comparacion': 'Se comprueba dentro del xml, normalmente cero'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Datos_Medicion/Fecha_Medicion', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Datos_Medicion_Fecha_Medicion', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF (la más antigua)'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/IdEquipo', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_IdEquipo', 'Comparacion': 'Se compara con PDF adjunto con mismo nombre que xml'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Fecha_Ultima_Calibracion', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Fecha_Ultima_Calibracion', 'Comparacion': 'Se comprueba dentro del xml, es un valor numero'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Umbral_Deteccion_Vm', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Umbral_Deteccion_Vm', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Longitud_Cable', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Longitud_Cable', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Medidor/Marca_Medidor', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Medidor_Marca_Medidor', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Medidor/Modelo_Medidor', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Medidor_Modelo_Medidor', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Medidor/Numero_Serie_Medidor', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Medidor_Numero_Serie_Medidor', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Antena/Marca_Antena', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Antena_Marca_Antena', 'Comparacion': 'SE COMPARA CON LAS HOJAS DE CERTIFICADOS DE CALIBRACIÓN DEL PDF'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Antena/Modelo_Antena', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Antena_Modelo_Antena', 'Comparacion': 'Se comprueba dentro del xml, se nmera el punto de medida'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Equipos_Medida_Fase1/Equipo_Medida_Fase1/Antena/Numero_Serie_Antena', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Equipos_Medida_Fase1_Equipo_Medida_Fase1_Antena_Numero_Serie_Antena', 'Comparacion': 'Se comprueba dentro del xml, coincide con la del equipo usando'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/IdPunto', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_IdPunto', 'Comparacion': 'Se comprueba dentro del xml, minimo 7 minutos de diferencia de una medida a otra'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/IdEquipo', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_IdEquipo', 'Comparacion': 'Se comprueba el fichero de referencia pdf y se usa la frecuencia mas baja del emplazamiento'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/Hora_Inicio_Medicion', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_Hora_Inicio_Medicion', 'Comparacion': 'Se comprueba dentro del xml, mitad del nivel de referencia'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/Nivel_Referencia_Vm', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_Nivel_Referencia_Vm', 'Comparacion': 'Se comprueba dentro del xml, numero menor que humbral'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/Nivel_Decision_Vm', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_Nivel_Decision_Vm', 'Comparacion': 'Se comprueba dentro del xml, mayor que valor promedio'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/Valor_Medido_Promediado_Vm', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_Valor_Medido_Promediado_Vm', 'Comparacion': 'Se comprueba dentro del xml'}
,{'Etiqueta': './/Informe_Medidas/Informe_Medidas_Fase1/Medicion_Fase1/Medida_Fase1/Valor_Calculado_Vm', 'Regla': 'R_Informe_Medidas_Informe_Medidas_Fase1_Medicion_Fase1_Medida_Fase1_Valor_Calculado_Vm', 'Comparacion': 'Se comprueba dentro del xml'}
...
,{'Etiqueta': './/Documentos/Informacion_Adicional/Documento/Nombre', 'Regla': 'R_Documentos_Informacion_Adicional_Documento_Nombre', 'Comparacion': 'Se comprueba dentro del xml'}
,{'Etiqueta': './/Documentos/Informacion_Adicional/Documento/Extension', 'Regla': 'R_Documentos_Informacion_Adicional_Documento_Extension', 'Comparacion': 'Se comprueba dentro del xml'}
