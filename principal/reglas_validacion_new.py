...
def reglas_validacion_individual(etiqueta, regla, vdato, fichero, ficheros_respaldo, carpeta_trabajo, pdf_texto, fichero_texto_cap, fichero_tecnico, datos_pdf_tecnico, Array_Ventana):
    ...
    if regla == 'R_Datos_Certificacion_Tipo_Certificacion':
        ...
        d['Valor'] = vdato
        d['OK_KO'] = 'OK/VISUAL'
        d['Validacion'] = 'Para la presente versión se debe revisar Infoantenas Visualmente'
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        c = procesos_comunes.busca_texto_titulo_documento(fichero_nombre.strip(), vdato.strip())
        if vdato.strip() != c['Elemento_Encontrado']:
            d['OK_KO'] = 'KO'
        ...
        d['Valor'] = vdato
        d['OK_KO'] = 'OK/VISUAL'
        d['Validacion'] = 'Para la presente versión se debe revisar Iberpix Visualmente'
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        V.append('Para la presente etapa, la validación debe ser visual')
        ...
        tipo_estacion = procesos_comunes.valor_elemento_xml(fichero,
            ...
            'Valor']
        if vdato.upper() == "SI":
            if not (tipo_estacion.upper() == 'ER1' or tipo_estacion.upper() == 'ER2'):
                d['OK_KO'] = "KO"
                V.append('Sólo si es ER1 o ER2 puede ser SI')
        if not re.match("SI|NO", vdato):
            d['OK_KO'] = "KO"
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Tipo_Potencia_Radiada':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Tipo_Potencia_Radiada':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Tipo_Potencia_Radiada':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Tipo_Potencia_Radiada':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        tipo_estacion = procesos_comunes.valor_elemento_xml(fichero,
                                                            './/Estacion_Certificada/Datos_Estacion/Tipo_Estacion')['Valor']
        if tipo_estacion.upper() == 'ER1' or tipo_estacion.upper() == 'ER3':
            try:
                if float(vdato) <= 10:
                    d['OK_KO'] = 'KO'
        ...
        if tipo_estacion.upper() == 'ER2' or tipo_estacion.upper() == 'ER4':
            try:
                if float(vdato) > 10:
                    d['OK_KO'] = 'KO'
                    V.append('Cuando Tipo Estación es ' + tipo_estacion + '  debe ser PIRE <= 10W')
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Unidad_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Unidad_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Unidad_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Unidad_Potencia_Maxima_Total':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Localizacion_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato.upper() == "INTERIOR":
            interior = procesos_comunes_segunda_etapa.antena_interior(Array_Ventana, "Sector1")
            if interior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Interior para el Sector1')
        if vdato.upper() == "EXTERIOR":
            exterior = procesos_comunes_segunda_etapa.antena_exterior(Array_Ventana, "Sector1")
            if exterior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Exterior para el Sector1')
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Localizacion_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato.upper() == "INTERIOR":
            interior = procesos_comunes_segunda_etapa.antena_interior(Array_Ventana, "Sector2")
            if interior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Interior para el Sector2')
        if vdato.upper() == "EXTERIOR":
            exterior = procesos_comunes_segunda_etapa.antena_exterior(Array_Ventana, "Sector2")
            if exterior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Exterior para el Sector2')
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        if not re.match("EXTERIOR|INTERIOR", vdato):
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Localizacion_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato.upper() == "INTERIOR":
            interior = procesos_comunes_segunda_etapa.antena_interior(Array_Ventana, "Sector3")
            if interior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Interior para el Sector3')
        if vdato.upper() == "EXTERIOR":
            exterior = procesos_comunes_segunda_etapa.antena_exterior(Array_Ventana, "Sector3")
            if exterior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Exterior para el Sector3')
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        if not re.match("EXTERIOR|INTERIOR", vdato):
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Localizacion_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato.upper() == "INTERIOR":
            interior = procesos_comunes_segunda_etapa.antena_interior(Array_Ventana, "Sector4")
            if interior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Interior para el Sector4')
        if vdato.upper() == "EXTERIOR":
            exterior = procesos_comunes_segunda_etapa.antena_exterior(Array_Ventana, "Sector4")
            if exterior.upper() == vdato.upper():
                d['OK_KO'] = 'KO'
                V.append('En la pantalla inicial no se ha seleccionado Antena Exterior para el Sector4')
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        if not re.match("EXTERIOR|INTERIOR", vdato):
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Tipo_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Tipo_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Tipo_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Tipo_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Polarizacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Polarizacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Polarizacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Polarizacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Altura_Antena_Sobre_Terreno':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        altura_antena = procesos_comunes_segunda_etapa.altura_antena(Array_Ventana, 'Sector1')
        if altura_antena != vdato :
            d['OK_KO'] = 'KO'
            V.append('El dato ingresado en la ventana principal '+ altura_antena +' no coincide con el dato encontrado en el fichero XML ' + vdato)
        #V.append('Para la presente etapa, la validación debe ser visual')
        d['Validacion'] = V
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Altura_Antena_Sobre_Terreno':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        altura_antena = procesos_comunes_segunda_etapa.altura_antena(Array_Ventana, 'Sector2')
        if altura_antena != vdato:
            d['OK_KO'] = 'KO'
            V.append(
                'El dato ingresado en la ventana principal ' + altura_antena + ' no coincide con el dato encontrado en el fichero XML ' + vdato)
        d['Validacion'] = V
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Altura_Antena_Sobre_Terreno':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        altura_antena = procesos_comunes_segunda_etapa.altura_antena(Array_Ventana, 'Sector3')
        if altura_antena != vdato:
            d['OK_KO'] = 'KO'
            V.append(
                'El dato ingresado en la ventana principal ' + altura_antena + ' no coincide con el dato encontrado en el fichero XML ' + vdato)
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Altura_Antena_Sobre_Terreno':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        if vdato is None:
            d['OK_KO'] = 'KO'
            V.append('No existe valor')
        altura_antena = procesos_comunes_segunda_etapa.altura_antena(Array_Ventana, 'Sector4')
        if altura_antena != vdato:
            d['OK_KO'] = 'KO'
            V.append(
                'El dato ingresado en la ventana principal ' + altura_antena + ' no coincide con el dato encontrado en el fichero XML ' + vdato)
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Inclinacion_Haz_Sobre_Horizontal':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Inclinacion_Haz_Sobre_Horizontal':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Inclinacion_Haz_Sobre_Horizontal':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Inclinacion_Haz_Sobre_Horizontal':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Tipo_Ganancia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Tipo_Ganancia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Tipo_Ganancia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Tipo_Ganancia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Ganancia_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Ganancia_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Ganancia_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Ganancia_Antena':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Apertura_Horizontal_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Apertura_Horizontal_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Apertura_Horizontal_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Apertura_Horizontal_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Apertura_Vertical_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Apertura_Vertical_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Apertura_Vertical_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Apertura_Vertical_Haz':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Acimut_Maxima_Radiacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Acimut_Maxima_Radiacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Acimut_Maxima_Radiacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Acimut_Maxima_Radiacion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Antena_Directiva_Nivel_Lobulos_Secundarios':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Antena_Directiva_Nivel_Lobulos_Secundarios':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Antena_Directiva_Nivel_Lobulos_Secundarios':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Antena_Directiva_Nivel_Lobulos_Secundarios':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Volumen_Referencia_Forma_Volumen':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Volumen_Referencia_Forma_Volumen':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Volumen_Referencia_Forma_Volumen':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Volumen_Referencia_Forma_Volumen':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Volumen_Referencia_Distancia_Referencia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Volumen_Referencia_Distancia_Referencia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Volumen_Referencia_Distancia_Referencia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Volumen_Referencia_Distancia_Referencia':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector1_Volumen_Referencia_Coeficiente_Reflexion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector2_Volumen_Referencia_Coeficiente_Reflexion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector3_Volumen_Referencia_Coeficiente_Reflexion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
        ...
        d['Fecha_Hora'] = datetime.datetime.now()
        return d
    elif regla == 'R_Estacion_Certificada_Datos_Estacion_Sectores_Sector4_Volumen_Referencia_Coeficiente_Reflexion':
        d['Etiqueta'] = etiqueta
        d['Valor'] = vdato
        d['OK_KO'] = 'OK'
        d['Validacion'] = ''
